...
export const luisarenas: Student = {
  ...
  username: 'luis-arenas',

  // EN: Your full name
  // ES: Tu nombre completo
  name: 'Luis David Rincon Arenas',
  ...
  profileImage: 'public/fullstack-course/students/luis-arenas/img.jpg',

  // EN: Your social media links (optional fields)
  // ES: Tus enlaces de redes sociales (campos opcionales)
  socials: {
    github: 'https://github.com/Luis4renas-ui',
    twitter: 'https://x.com/LuisAre95473089',
