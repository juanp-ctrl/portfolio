...
export const JaimeLondonoSaldarriaga: Student = {
  ...
  name: 'Jaime Londoño Saldarriaga',
  ...
  profileImage: '/fullstack-course/students/Jaime-Londoño-Saldarriaga/Foto Perfil 3.jpg',
