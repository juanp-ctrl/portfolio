...
export const jeiksonGomez: Student = {
  ...
  username: 'jeikson-gomez',

  // EN: Your full name
  // ES: Tu nombre completo
  name: 'Jeikson Andres Gómez Jaramillo',

  // EN: A short biography about yourself (2-3 sentences)
  // ES: Una biografía corta sobre ti (2-3 oraciones)
  bio: 'Publicist and web designer from Medellín, Colombia. Passionate about technology and creativity.',
  ...
  profileImage: '/fullstack-course/students/jeikson-gomez/profile.webp',
