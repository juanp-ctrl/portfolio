...
export const juanFernandoDavid: Student = {
  ...
  profileImage: '/fullstack-course/students/juan-fernando-david/imagen.jpg',

  // EN: Your social media links (optional fields)
  // ES: Tus enlaces de redes sociales (campos opcionales)
  socials: {
    github: 'https://github.com/juanfer03',
    linkedin: 'https://www.linkedin.com/in/juan-fernando-david-vera/',
